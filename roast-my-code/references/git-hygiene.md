...
- **Deduction:** -20 points
- **Roast:** "No .gitignore? Bold of you to share everything with the world. Your OS metadata, editor configs, and build artifacts are living rent-free in this repo."
...
- **Deduction:** -20 points
- **Roast:** "You committed node_modules. That's {n}MB of 'I don't understand .gitignore'. Every npm install recreates this folder -- that's the whole point of package.json."
...
- **Deduction:** -10 points
- **Roast:** "You're tracking a {size}MB binary in git. Git is not Google Drive. Every clone of this repo downloads that blob for all eternity, even if you delete it later."
...
- **Deduction:** -20 points
- **Roast:** "Your API key is in git history. Even if you deleted the file, git remembers. Git always remembers. That secret is now part of the permanent archaeological record of this repository."
...
- **Deduction:** -4 points
- **Roast:** "One branch to rule them all? You're deploying without a safety net. Feature branches exist so your broken experiments don't take down main."
...
- **Deduction:** -4 points
- **Roast:** "This commit touches {n} files. That's not a commit, that's a deployment. Good luck writing a revert for this monstrosity. `git bisect` weeps."
...
- **Deduction:** -4 points
- **Roast:** "Commit message: 'fix'. Fix what? My will to review this? Your git log reads like a drunk person's autocomplete suggestions. Future you is going to hate present you."
...
- **Deduction:** -1 point
- **Roast:** "Pushing directly to main with zero review process. Living dangerously. One typo away from deploying a disaster, and nobody's there to catch it."
...
- **Deduction:** -1 point
- **Roast:** "Your git log is 40% merge commits. It's like reading a novel where every other page says 'and then the chapters were combined.' Rebase exists. Use it."
...
- **Deduction:** -1 point
- **Roast:** "You have branches older than some democracies. '{branch}' was last touched 4 months ago. Either finish it or bury it -- this limbo helps nobody."
...
- **Deduction:** -4 points
- **Roast:** "No README? How do you expect anyone -- including future you -- to know what this does? This repo is a mystery box, and not the fun kind."
